...
app.post("/nueva", function (req, res) {
    setTimeout(function() {
      ...
      if ((req.body.id != undefined && req.body.id != "") && (req.body.nombre != undefined && req.body.nombre != "") && (req.body.cuatrimestre != undefined && req.body.cuatrimestre != "") && (req.body.fechaFinal != undefined && req.body.fechaFinal != "") && (req.body.turno != undefined && req.body.turno != "")) {
			  id = id + 1;
